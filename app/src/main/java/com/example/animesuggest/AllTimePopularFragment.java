...
import com.example.AllTimeAnimeQuery;
...
public class AllTimePopularFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_alltime, container, false);
        mlist.clear();
...
//        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        ...
        apolloClient.query(
                AllTimeAnimeQuery.builder()
                        .page(4)
                        .build()
        ).enqueue(new ApolloCall.Callback<AllTimeAnimeQuery.Data>() {
            @Override
